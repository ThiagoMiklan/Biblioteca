...
const itens_link =[{value: "Dropdown Button" ,link:true, href:"https://ufsc.br", onClick:()=>{alert("Clicou")}},
...
const itens_div =[
            {value: <p>You can insert <strong>any type of content</strong> within the dropdown menu.</p>, onClick:()=> 
            {alert("Clicou")}},
...
const HookDropDown = (props) => {
 ...
 ReactDOM.render(
        <>
          ...
          <DropDown definition="is-hoverable" itens={itens_link}/>
          <DropDown definition="is-up is-active" itens={itens_link}/>
        </>
     ,
