...
test('card 1 with media object', function () {
  var cardWithMedia = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_Card.default, {
    definition: "is-background-light",
    ...
    datetime: "2016-1-1"
  }, "11:09 PM - 1 Jan 2016")))).toJSON();

  expect(cardWithMedia).toMatchSnapshot();
});
test('card with content', function () {
  var cardWithContent = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_Card.default, {
...
test('card with title and subtitle', function () {
  var cardWithTitle = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_Card.default, {
