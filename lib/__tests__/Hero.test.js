...
test('hero colors', function () {
  var colors = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Hero.default, {
    title: "Hero Title",
...
test('hero bold', function () {
  var bold = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Hero.default, {
...
test('hero merge', function () {
  var merge = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Hero.default, {
...
test('navigation bar', function () {
  var nav = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_NavigationBar.default, {
...
test('three parts', function () {
  var nav = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_HeroThreeParts.default, {
